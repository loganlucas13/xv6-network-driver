...
void
getcallerpcs(void*, addr_t*);
void
getstackpcs(addr_t*, addr_t*);
int
...
argaddr(int, addr_t*);
int
fetchaddr(addr_t, addr_t*);
int
fetchstr(addr_t, char**);
int
fetchint(addr_t, int*);
...
uva2ka(pml4e_t*, char*);
addr_t
allocuvm(pml4e_t*, uint64, uint64);
addr_t
deallocuvm(pml4e_t*, uint64, uint64);
void
freevm(pml4e_t*);
void
inituvm(pml4e_t*, char*, uint);
int
loaduvm(pml4e_t*, char*, struct inode*, uint, uint);
pde_t*
copyuvm(pml4e_t*, uint);
void
switchuvm(struct proc*);
void
switchkvm(void);
int
copyout(pml4e_t*, addr_t, void*, uint64);
void
